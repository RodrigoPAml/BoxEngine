...
function text.update()
    ...
    engine.font.set_text(this._font_id, this.text)
    engine.font.set_position(this._font_id, { x = this.x, y = this.y })
    engine.font.set_color(this._font_id, { x = 1, y = 0, z = 0 })
    engine.font.set_scale(this._font_id, { x = 1, y = 1 })
    engine.font.draw(this._font_id)

    local text_size = engine.font.get_text_size(this._font_id);
